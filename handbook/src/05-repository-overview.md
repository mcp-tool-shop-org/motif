...
Motif uses a monorepo because:

- **Shared types**: The `@motif-studio/schema` package defines all types. Every other package imports from it. A monorepo makes this dependency trivial.
