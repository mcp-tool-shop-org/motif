...
- `@motif/schema` — tipi per clip, note, segnali
- `@motif/instrument-rack` — gestione delle voci per la riproduzione
- `@motif/music-theory` — primitive per scale, accordi e motivi
