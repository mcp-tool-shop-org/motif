...
- `@motif/schema` — types pour les scènes, les pistes et les transitions
- `@motif/audio-engine` — primitives de lecture d'échantillons
- `@motif/scene-mapper` — évaluation des déclencheurs pour la résolution des scènes
