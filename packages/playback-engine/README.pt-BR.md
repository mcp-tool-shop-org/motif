...
- `@motif/schema` — tipos para cenas, camadas e transições
- `@motif/audio-engine` — elementos básicos para reprodução de amostras
- `@motif/scene-mapper` — avaliação de gatilhos para resolução de cenas
