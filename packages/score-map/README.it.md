...
- Gestione di scene/tracce/binding (vedere `@motif/schema`)
- Automazione (vedere `@motif/automation`)
- Componenti dell'interfaccia utente

## Dipendenze

- `@motif/schema` — tipi per motivi, profili, scene, famiglie di segnali, derivazioni
