...
export const config: SiteConfig = {
  ...
  hero: {
    ...
    previews: [
      { label: 'npm', code: 'npm install @motif/schema @motif/clip-engine' },
  ...
  sections: [
    ...
    },
    {
      ...
      rows: [
        ['@motif/schema', 'Canonical types and Zod validation'],
        ['@motif/asset-index', 'Pack integrity indexing and auditing'],
        ['@motif/audio-engine', 'Sample playback and voice management'],
        ['@motif/clip-engine', 'Clip sequencing, transforms, cue scheduling'],
        ['@motif/instrument-rack', 'Multi-oscillator synth, drum voice, sample voice, LFO modulation'],
        ['@motif/music-theory', 'Scales, chords, motifs, intensity'],
        ['@motif/playback-engine', 'Real-time playback, mixing, 8 FX types, MIDI I/O, WAV export'],
        ['@motif/sample-lab', 'Trim, slice, kit, instrument helpers'],
        ['@motif/score-map', 'Motifs, profiles, cue families, derivation'],
        ['@motif/automation', 'Lanes, macros, envelopes, capture'],
        ['@motif/library', 'Templates, snapshots, branches, favorites'],
        ['@motif/scene-mapper', 'Trigger mapping and scene resolution'],
        ['@motif/runtime-pack', 'Runtime export/import'],
